...
(async () => {
  ...
  await fs.writeFile("exercise-testing-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("exercise-testing-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
